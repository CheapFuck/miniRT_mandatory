...
/*                                                   +#+                      */
/*   Created: 2024/12/13 15:05:39 by diwang        #+#    #+#                 */
/*   Updated: 2024/12/13 15:11:43 by diwang        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	world_to_local(t_vector point, t_vector orientation,
				t_vector center);
int			intersect_cylinder_cap(t_ray *ray, t_cylinder *cylinder,
				t_vector axis, double half_height, double *t_cap);
...
// double		compute_shadow_factor(t_vector hit_point, t_light light,
// 				t_scene *scene, int num_samples);
// // static t_color	compute_light_contribution
